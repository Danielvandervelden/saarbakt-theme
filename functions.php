...
function saarbakt_files() {
	...
	wp_enqueue_style( 'saarbakt styles', get_stylesheet_directory_uri() . '/style.css', array(), '4.1.1');

	wp_register_script("main javascript", get_bloginfo("stylesheet_directory") . "js/script.js");
	wp_enqueue_script('main-saarbakt-js', get_theme_file_uri('js/script.js'), array('jquery'), '2.0.2', true);
