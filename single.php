...
<div class="navigationblog">
	<div class="backbuttonblog">
		<form action="<?php echo site_url('/recepten') ?>">
			<button class="btn" type="submit"><i class="fa fa-chevron-left" aria-hidden="true"></i> Terug naar Recepten</button>
		</form>
	...
	<div class="receptenbox">
		...
		<div class="ingredientenflex">
			<div class="ingredientencontent">
				<p><?php echo get_field('ingredienten'); ?></p>
			</div>
			<div class="post-thumbnail-single"><?php the_post_thumbnail('thumbnailimagesingle'); ?></div>
		</div>
	</div>
